...
import { ThumbnailMakerComponent } from '@elementar-rt/components/thumbnail-maker';
import { UploadFileSelectedEvent, UploadTriggerDirective } from '@elementar-rt/components/upload';
